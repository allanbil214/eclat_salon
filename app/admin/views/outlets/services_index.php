...
<div class="adm-head">
    ...
    <div style="display:flex;gap:10px;align-items:center">
        ...
        <button type="button" class="adm-btn" id="js-import-btn"><i class="fa-solid fa-download"></i> Import from global</button>
        <?php endif; ?>
        <a class="adm-btn adm-btn--primary" href="<?= e(admin_url('outlets/services/new?outlet_id=' . (int) $outlet['id'])) ?>"><i class="fa-solid fa-plus"></i> Add service</a>
    ...
    <?php foreach ($rows as $r): ?>
        <tr>
            ...
            <td class="adm-row-actions">
                <a class="adm-btn adm-btn--sm" href="<?= e(admin_url('outlets/services/edit?outlet_id=' . (int) $outlet['id'] . '&id=' . (int) $r['id'])) ?>"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
