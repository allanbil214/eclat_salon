...
<div class="adm-head">
    ...
    <a class="adm-btn adm-btn--primary" href="<?= e(admin_url('gallery/categories/new')) ?>">+ New category</a>
</div>
    ...
    <?php foreach ($cats as $c): ?>
        <tr>
            ...
            <td class="adm-row-actions">
                <a href="<?= e(admin_url('gallery/categories/edit?id=' . $c['id'])) ?>">Edit</a>
                <form method="post" action="<?= e(admin_url('gallery/categories/delete')) ?>" onsubmit="return confirm('Delete this category AND its <?= (int) $c['item_count'] ?> photo(s)?');"><?= csrf_field() ?><input type="hidden" name="id" value="<?= (int) $c['id'] ?>"><button type="submit" class="adm-link-danger">Delete</button></form>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
