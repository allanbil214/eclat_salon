...
<div class="adm-head">
    ...
    <div class="adm-head-actions">
        ...
        <a class="adm-btn adm-btn--primary" href="<?= e(admin_url('gallery/new')) ?>">+ New photo</a>
    </div>
</div>
    ...
    <?php foreach ($items as $g): ?>
        <tr>
            ...
            <td class="adm-row-actions">
                <a href="<?= e(admin_url('gallery/edit?id=' . $g['id'])) ?>">Edit</a>
                <form method="post" action="<?= e(admin_url('gallery/delete')) ?>" onsubmit="return confirm('Delete this photo?');"><?= csrf_field() ?><input type="hidden" name="id" value="<?= (int) $g['id'] ?>"><button type="submit" class="adm-link-danger">Delete</button></form>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
