<?php /** Vars: $rows */ ?>
<div class="adm-head"><h1 class="adm-h1">Brands</h1><a class="adm-btn adm-btn--primary" href="<?= e(admin_url('brands/new')) ?>">+ New brand</a></div>
    ...
    <?php foreach ($rows as $b): ?>
        <tr>
            ...
            <td class="adm-row-actions">
                <a href="<?= e(admin_url('brands/edit?id=' . $b['id'])) ?>">Edit</a>
                <form method="post" action="<?= e(admin_url('brands/delete')) ?>" onsubmit="return confirm('Delete this brand?');"><?= csrf_field() ?><input type="hidden" name="id" value="<?= (int) $b['id'] ?>"><button type="submit" class="adm-link-danger">Delete</button></form>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
