...
<table class="adm-table">
    <thead><tr><th>Name</th><th class="w-min">Phone</th><th class="w-min">Outlet</th><th class="w-min">Service</th><th class="w-min">Preferred date</th><th class="w-min">Received</th><th class="w-min"></th></tr></thead>
    <tbody>
    <?php foreach ($rows as $b): ?>
        <tr>
            <td><strong><?= e($b['name']) ?></strong></td>
            <td class="adm-muted"><?= e($b['phone']) ?: '—' ?></td>
            <td class="adm-muted"><?= e($b['outlet_name'] ?? '') ?: '—' ?></td>
