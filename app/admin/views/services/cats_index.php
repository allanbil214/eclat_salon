<?php /** Vars: $cats */ ?>
<div class="adm-head"><h1 class="adm-h1">Service categories</h1><a class="adm-btn adm-btn--primary" href="<?= e(admin_url('services/categories/new')) ?>"><i class="fa-solid fa-plus"></i> New category</a></div>
    ...
    <?php foreach ($cats as $c): ?>
        <tr>
            ...
            <td class="adm-row-actions">
                <a class="adm-btn adm-btn--sm" href="<?= e(admin_url('services/categories/edit?id=' . $c['id'])) ?>"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                <form method="post" action="<?= e(admin_url('services/categories/delete')) ?>" onsubmit="return confirm('Delete this category AND its <?= (int) $c['item_count'] ?> service(s)?');"><?= csrf_field() ?><input type="hidden" name="id" value="<?= (int) $c['id'] ?>"><button type="submit" class="adm-link-danger"><i class="fa-solid fa-trash"></i></button></form>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
