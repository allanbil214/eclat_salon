...
<table class="adm-table">
    <thead><tr><th class="w-min"></th><th>Name</th><th class="w-min">Role</th><th>Specialty</th><th class="w-min">Outlet</th><th class="w-min">Status</th><th class="w-min">Order</th><th class="w-min"></th></tr></thead>
    <tbody>
    <?php foreach ($rows as $m): ?>
        <tr>
            ...
            <td class="adm-muted"><?= e($m['outlet_name'] ?? '') ?: '—' ?></td>
